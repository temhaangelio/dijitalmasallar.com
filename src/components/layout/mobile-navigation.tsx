...
const items = [["Dashboard", "/dashboard", null], ["Yazılar", "/yazilar", "posts"], ["E-bülten", "/e-bulten", "newsletter"], ["Reklamlar", "/reklamlar", "ads"], ["İstatistik", "/istatistik", "analytics"], ["Ayarlar", "/ayarlar", null]] as const;
