...
const items = [["Dashboard", "/dashboard", null], ["Yazılar", "/yazilar", "posts"], ["RSS", "/rss", "rss"], ["Reklamlar", "/reklamlar", "ads"], ["İstatistik", "/istatistik", "analytics"]] as const;
