      ...
      {showHeader ? <>
        ...
        <div data-reading={reading || undefined} className="visitor-masthead relative z-[1] flex w-full max-w-[640px] flex-col items-center pb-2 pt-6 sm:pb-3 sm:pt-8">
          ...
          <div className="flex w-full items-center justify-between gap-2">
            <div className="flex min-h-11 items-center gap-3"><Skeleton className="size-9 rounded-[12px] sm:size-10 sm:rounded-[13px] xl:size-[52px] xl:rounded-[16px]" />{reading ? <Skeleton className="h-4 w-32" /> : null}</div>
