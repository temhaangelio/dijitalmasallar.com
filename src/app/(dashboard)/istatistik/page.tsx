...
export default async function AnalyticsPage({ searchParams }: { searchParams: Promise<{ aralik?: string | string[] }> }) {
  ...
  return <AppShell active="/istatistik"><PageHeader title="İstatistik" note="Vercel Web Analytics · gerçek ziyaretçi verileri" /><AnalyticsDashboard analytics={analytics} range={range} missingEnv={missingAnalyticsEnv()} /></AppShell>;
}
